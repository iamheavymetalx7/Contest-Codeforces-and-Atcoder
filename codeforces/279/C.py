...
def solve():
    ...
    non_inc = [i for i in range(n)]

    non_dec = [i for i in range(n)]
    ...
    # print("non-inc",non_inc)
    # print("non-dec",non_dec)
    for _ in range(q):
        l,r=lmii()

        if non_inc[r-1]-non_dec[l-1]<=0:
            # print(non_inc[r-1], non_dec[l-1],end=" ")
            print("Yes")
        else:
            print("No") 
